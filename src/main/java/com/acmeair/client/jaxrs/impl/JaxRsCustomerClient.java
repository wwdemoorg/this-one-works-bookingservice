...
public class JaxRsCustomerClient extends JaxRsClient implements CustomerClient {
  ...
  public void init() {
    if (customerTargetBase == null) {
      ...
      customerTargetBase = customerClient.target("http://" + customerServiceLoc + UPDATE_REWARD_PATH);
    }
  }
   ...
   * Update reward miles.
   */
  public String updateTotalMiles(String customerId, String miles) {
    ...
    Long totalMilesLong = jsonObject.getJsonNumber("total_miles").longValue();
    return totalMilesLong.toString();
  }
}
