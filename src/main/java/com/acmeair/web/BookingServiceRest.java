...
public class BookingServiceRest {
  ...
  @Produces("text/plain")
  @Timed(name = "com.acmeair.web.BookingServiceRest.getBookingByNumber",tags="app=bookingservice-java") 
  ...
  @Path("/byuser/{user}")
  @Produces("text/plain")
  @Timed(name = "com.acmeair.web.bookFlights.BookingServiceRest.getBookingsByUser",tags = "app=bookingervice-java")
  ...
  @Path("/cancelbooking")
  @Produces("text/plain")
  @Timed(name = "com.acmeair.web.bookFlights.BookingServiceRest.cancelBookingsByNumber",tags = "app=bookingervice-java")
