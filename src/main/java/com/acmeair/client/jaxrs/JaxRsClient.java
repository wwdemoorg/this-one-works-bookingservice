...
public class JaxRsClient {
  ...
  /* microprofile-1.1 */
  @Inject 
  @ConfigProperty(name = "CUSTOMER_SERVICE", defaultValue = "localhost:6379/customer") 
  protected String customerServiceLoc;
  
  /* microprofile-1.1 */
  @Inject 
  @ConfigProperty(name = "FLIGHT_SERVICE", defaultValue = "localhost:6379/flight") 
  protected String flightServiceLoc;
